    ...
    public class MouseHelper : IDisposable
    {
       ...
       // private MouseEventHandler MouseClick;
        ...
        internal MouseHelper(UIElement element, UIElement captureElement)
        {
            ...
            //this._element.MouseMove += new MouseEventHandler(_element_MouseMove);
        ...
        void _element_MouseMove(object sender, MouseEventArgs e)
        {
            //this.MouseMove.Invoke(this._element, e);
        }
