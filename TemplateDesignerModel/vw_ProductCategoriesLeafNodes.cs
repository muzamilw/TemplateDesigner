...
namespace TemplateDesignerModelTypes
{
    ...
    public partial class vw_ProductCategoriesLeafNodes: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int ParentCategoryID
        {
            ...
            set
            {
                if (_parentCategoryID != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'ParentCategoryID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
