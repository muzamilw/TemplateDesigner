...
//             'rotate';
    ...
    _scaleObject: function (x, y, by) {
      ...
      {
            if (!by) {
                var diffx = lastLen+ curLen+ x- t.ex;
                var diffy = lastLen+ curLen+ y- t.ey;
...
//      }
 ...
 //this.width = this.maxWidth;
     ...
     _render: function(context) {
        ...
        this.wrapText(context,this.text,xPos, -this.height/2 + this.fontSize ,this.maxWidth,this.lineHeight * this.fontSize);
        this.setCoords();
         },
